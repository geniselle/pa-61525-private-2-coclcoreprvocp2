...
export CLUSTERID=coclcoreprvocp2 <2>
...
export VCENTER_DS='DS_CBT_COCLCOREPRVOCP2' <6>
...
cat <<EOF > append-bootstrap.ign
{
  "ignition": {
    "config": {
      "append": [
        {
          "source": "http://10.32.75.59:80/ocp/ignition/bootstrap.ign",
          "verification": {}
        }
      ]
    },
...
----
curl http://W10.32.75.59:80/ocp/ignition/bootstrap.ign
----
...
INFO Waiting up to 30m0s for the Kubernetes API at https://api.coclcoreprvocp2.corp.popular.local:6443...
INFO API v1.27.3 up
...
INFO Waiting up to 30m0s for the cluster at https://api.coclcoreprvocp2.corp.popular.local:6443 to initialize...
...
INFO Access the OpenShift web-console here: https://console-openshift-console.apps.api.coclcoreprvocp2.corp.popular.local
...
openshift-apiserver                        4.14.37   True        False         False      19d
...
operator-lifecycle-manager-packageserver   4.14.37   True        False         False      11d
